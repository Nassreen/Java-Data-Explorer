...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-08-18T13:38:30.005511+02:00[Europe/Berlin]")
public class Person {
  ...
  @Valid
  private List<@Valid Anschrift> anschriften;

  @Valid
  private List<@Valid Kommunikationsadresse> kommunikationsadressen;

  @Valid
  private List<@Valid Bankverbindung> bankverbindungen;

  /**
   * Default constructor
   * @deprecated Use {@link Person#Person(Long)}
   */
  @Deprecated
  public Person() {
    super();
